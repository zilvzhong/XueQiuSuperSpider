...
func init()  {
	SiteUrl = []string{
		...
		"https://xueqiu.com/v4/statuses/user_timeline.json?page=1&user_id=1520470953&type=0",
		//"https://xueqiu.com/v4/statuses/user_timeline.json?page=1&user_id=5998941116",
	}
}